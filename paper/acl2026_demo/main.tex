...
Source code and reproducibility artifacts are available at \url{https://github.com/A-Dawn/A_memorix/releases/tag/acl2026-demo-v1.1.1}.
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.98\textwidth]{system_flowchart.pdf}
\caption{System flow used in the ACL demo. Import tasks, temporal query, and memory APIs are modeled as separate request paths over shared stores; freeze/prune are background maintenance operations rather than direct \texttt{/v1/memory/*} endpoints.}
\label{fig:pipeline}
\end{figure*}
...
\begin{itemize}
  \item Source code and installable package: \href{https://github.com/A-Dawn/A_memorix/releases/tag/acl2026-demo-v1.1.1}{GitHub release (acl2026-demo-v1.1.1)}; package asset: \href{https://github.com/A-Dawn/A_memorix/releases/download/acl2026-demo-v1.1.1/acl2026-demo-v1.1.1.zip}{acl2026-demo-v1.1.1.zip}
  ...
  \item Demo video (\(\leq\)2.5 min): \href{https://github.com/A-Dawn/A_memorix/releases/download/acl2026-demo-v1.1.1/video.mp4}{video.mp4 (release asset)}
\end{itemize}
