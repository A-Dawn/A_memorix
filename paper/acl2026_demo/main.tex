...
Source code and reproducibility artifacts are available at \url{https://github.com/A-Dawn/A_memorix/releases/tag/acl2026-demo-v1.1.0}.
...
\begin{itemize}
  \item Source code and installable package: \href{https://github.com/A-Dawn/A_memorix/releases/tag/acl2026-demo-v1.1.0}{GitHub release (acl2026-demo-v1.1.0)}; package asset: \href{https://github.com/A-Dawn/A_memorix/releases/download/acl2026-demo-v1.1.0/acl2026-demo-v1.1.0.zip}{acl2026-demo-v1.1.0.zip}
  ...
  \item Demo video (\(\leq\)2.5 min): \href{https://github.com/A-Dawn/A_memorix/releases/download/acl2026-demo-v1.1.0/video.mp4}{video.mp4 (release asset)}
\end{itemize}
