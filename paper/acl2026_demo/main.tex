...
Source code and reproducibility artifacts are available at \url{https://github.com/A-Dawn/A_memorix/releases/tag/acl2026-demo-v1.0.0}.
...
\begin{itemize}
  \item Source code and installable package: \href{https://github.com/A-Dawn/A_memorix/releases/tag/acl2026-demo-v1.0.0}{GitHub release (acl2026-demo-v1.0.0)}; package asset: \href{https://github.com/A-Dawn/A_memorix/releases/download/acl2026-demo-v1.0.0/acl2026-demo-v1.0.0.zip}{acl2026-demo-v1.0.0.zip}
  ...
  \item Demo video entry point (temporary placeholder): \href{https://github.com/A-Dawn/A_memorix/releases/tag/acl2026-demo-v1.0.0}{release page (to be replaced by final video URL)}
\end{itemize}
