...
const (
	JobService_SubmitDeleteBySource_FullMethodName = "/a_memorix.api.v1.JobService/SubmitDeleteBySource"
	JobService_GetJob_FullMethodName               = "/a_memorix.api.v1.JobService/GetJob"
	JobService_ListJobs_FullMethodName             = "/a_memorix.api.v1.JobService/ListJobs"
	JobService_CancelJob_FullMethodName            = "/a_memorix.api.v1.JobService/CancelJob"
)
...
type JobServiceClient interface {
	SubmitDeleteBySource(ctx context.Context, in *SubmitDeleteBySourceRequest, opts ...grpc.CallOption) (*SubmitDeleteBySourceResponse, error)
...
func (c *jobServiceClient) SubmitDeleteBySource(ctx context.Context, in *SubmitDeleteBySourceRequest, opts ...grpc.CallOption) (*SubmitDeleteBySourceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SubmitDeleteBySourceResponse)
	err := c.cc.Invoke(ctx, JobService_SubmitDeleteBySource_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type JobServiceServer interface {
	SubmitDeleteBySource(context.Context, *SubmitDeleteBySourceRequest) (*SubmitDeleteBySourceResponse, error)
...
func (UnimplementedJobServiceServer) SubmitDeleteBySource(context.Context, *SubmitDeleteBySourceRequest) (*SubmitDeleteBySourceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitDeleteBySource not implemented")
}
...
func _JobService_SubmitDeleteBySource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitDeleteBySourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServiceServer).SubmitDeleteBySource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobService_SubmitDeleteBySource_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServiceServer).SubmitDeleteBySource(ctx, req.(*SubmitDeleteBySourceRequest))
	}
...
var JobService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "a_memorix.api.v1.JobService",
	HandlerType: (*JobServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SubmitDeleteBySource",
			Handler:    _JobService_SubmitDeleteBySource_Handler,
		},
		{
			MethodName: "GetJob",
	...
	Metadata: "a_memorix/api/v1/job.proto",
}
