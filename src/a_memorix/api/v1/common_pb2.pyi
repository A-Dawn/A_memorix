...
class ErrorDetail(_message.Message):
    __slots__ = ("code", "request_id", "trace_id", "retryable", "details", "message")
    ...
    message: str
    def __init__(self, code: _Optional[str] = ..., request_id: _Optional[str] = ..., trace_id: _Optional[str] = ..., retryable: _Optional[bool] = ..., details: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., message: _Optional[str] = ...) -> None: ...
