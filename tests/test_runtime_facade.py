...
from a_memorix.core.runtime.runtime_facade import KernelRuntimeFacade
from a_memorix.core.runtime.sdk_memory_kernel import SDKMemoryKernel
from a_memorix.core.utils.memory_lifecycle_policy import RelationLifecycleEvent


@pytest.mark.asyncio
async def test_runtime_facade_delegates_kernel_runtime_methods(monkeypatch: pytest.MonkeyPatch) -> None:
    events: list[tuple[str, Any]] = []
    kernel = SDKMemoryKernel(data_dir=Path.cwd(), config={"runtime": {"enabled": True}})
