...
def _build_retrieval_filter_kernel(config: dict[str, Any]) -> SDKMemoryKernel:
    kernel = SDKMemoryKernel(data_dir=Path.cwd(), config=config)
    ...
    hits = [
        {
            ...
            "hash": "para-summary-current",
            "content": "当前群聊摘要。",
            "metadata": {"chat_id": "session-current", "group_id": "group-current", "source_type": "chat_summary"},
        },
        {
            "type": "paragraph",
            "hash": "para-summary-other",
            "content": "其他群聊摘要。",
            "metadata": {"chat_id": "session-other", "group_id": "group-other", "source_type": "chat_summary"},
        },
    ]
