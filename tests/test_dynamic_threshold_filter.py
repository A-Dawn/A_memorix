...
from a_memorix.core.retrieval.dual_path import RetrievalResult
from a_memorix.core.retrieval.threshold import DynamicThresholdFilter, ThresholdConfig, ThresholdMethod
...
def test_runtime_threshold_defaults_are_stable() -> None:
    runtime_config = ThresholdConfig()

    assert runtime_config.min_threshold == approx(0.29)
    assert runtime_config.min_results == 4
