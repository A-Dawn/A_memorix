...
from a_memorix.core.retrieval import RetrievalResult, RetrievalScope
...
from a_memorix.core.runtime.services import memory_maintenance_service
from a_memorix.core.runtime.services.search_hit_processing_service import MemorySearchHitProcessingService
from a_memorix.core.runtime.services.v5_admin_service import MemoryV5AdminService
from a_memorix.core.storage.graph_store import GraphStore
from a_memorix.core.storage.metadata_store import MetadataStore
from a_memorix.core.storage.vector_store import VectorStoreIntegrityError
from a_memorix.core.utils.memory_lifecycle_policy import RelationLifecyclePolicy
...
async def test_graph_admin_delete_node_uses_kernel_patched_delete_action(monkeypatch: pytest.MonkeyPatch) -> None:
    kernel = SDKMemoryKernel(data_dir=Path.cwd(), config={})
...
def test_runtime_config_service_builds_runtime_bundle_from_kernel_state(
    ...
    kernel = SDKMemoryKernel(data_dir=Path.cwd(), config={"runtime": {"existing": True}})
...
async def test_runtime_config_service_apply_tuning_uses_kernel_patched_runtime_builder(
    ...
    kernel = SDKMemoryKernel(data_dir=Path.cwd(), config={"retrieval": {"old": 1}})
