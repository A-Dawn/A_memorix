...
from a_memorix.core.utils import person_profile_service as profile_service_module
from a_memorix.core.utils.person_profile_service import PROFILE_CLASSIFICATION_REQUEST_TYPE, PersonProfileService
from a_memorix.core.utils.profile_text import parse_profile_sections
...
async def test_profile_classification_uses_llm_buckets_and_guards_uncertain_stable_facts(
    ...
    async def fake_generate_with_resolved_model(*args, **kwargs):
        provider, model, request_type, prompt = args
        assert provider is llm_provider
